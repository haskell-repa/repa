...
-- Vector
repa_newVectorFloat       :: Word#  -> World -> (# World, Vector Float #)
repa_newVectorFloat len    = unwrapIO' (V.new len)
{-# INLINE repa_newVectorFloat #-}


repa_readVectorFloat      :: Vector Float -> Word# -> World -> (# World, Float# #)
...
repa_writeVectorFloat     :: Vector Float -> Word# -> Float# -> World -> World
repa_writeVectorFloat vec ix val   
        = unwrapIO_ (V.write vec ix (F# val))
{-# INLINE repa_writeVectorFloat #-}


repa_sliceVectorFloat     :: Word# -> Vector Float -> World -> (# World, Vector Float #)
